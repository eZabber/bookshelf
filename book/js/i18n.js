export const translations = {
    en: {
        ...
        'manual.add.body': 'Click the green "+" button to add books. You can Scan a Barcode (requires camera), Search by ISBN/Title (uses Google Books, OpenLibrary, Finna), or enter details Manually.',
        ...
        'manual.add.body': 'Lisää kirjoja "+" -painikkeesta. Voit skannata viivakoodin, hakea nimellä/ISBN:llä (Google Books, OpenLibrary, Finna) tai syöttää tiedot käsin.',
    ...
    et: {
        ...
        'manual.add.body': 'Lisa raamatuid "+" nupuga. Saad skaneerida triipkoodi, otsida nime/ISBN-i järgi (Google Books, OpenLibrary, Finna) või sisestada andmed käsitsi.',
