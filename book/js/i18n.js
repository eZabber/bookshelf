export const translations = {
    en: {
        ...
        'manual.add.body': 'Click the "Add Book" button to add books. You can Scan a Barcode (requires camera), Search by ISBN/Title (uses Google Books, OpenLibrary, Finna), or enter details Manually. You can also Import a CSV (Goodreads export or MyBookShelf backup).',
        ...
        'manual.add.body': 'Napsauta "Lisää Kirja" -painiketta lisätäksesi kirjoja. Voit skannata viivakoodin, hakea nimellä/ISBN:llä (Google Books, OpenLibrary, Finna) tai syöttää tiedot käsin. Voit myös tuoda CSV-tiedoston (Goodreads tai MyBookShelf-varmuuskopio).',
    ...
    et: {
        ...
        'manual.add.body': 'Klõpsa "Lisa Raamat" nuppu raamatute lisamiseks. Saad skaneerida triipkoodi, otsida nime/ISBN-i järgi (Google Books, OpenLibrary, Finna) või sisestada andmed käsitsi. Samuti saad importida CSV-faili (Goodreads või MyBookShelf varukoopia).',
