export const translations = {
    en: {
        ...
        'btn.import_json': 'Import Backup (JSON)',
        'btn.export_json': 'Export Backup (JSON)',
        ...
        'manual.privacy.title': 'Data & Backups',
        'manual.privacy.body': 'DATA: Your books are stored on this device and auto-synced to Google Drive (Green Dot). \n\nBACKUPS:\n• JSON Backup (Recommended): Saves EVERYTHING (including Images & Notes). Use this to transfer your library to another device.\n• CSV Export: Saves text only (Excel compatible). Images are NOT saved in CSV.',
        ...
        'manual.add.body': 'Click the "Add Book" button to add books. You can Scan a Barcode, Search, or enter details Manually. Use "Export Backup (JSON)" to save everything (INCLUDING IMAGES) and "Import Backup" to restore it.',
        ...
        'btn.export': 'Vie CSV',
        'btn.import_json': 'Tuo Varmuuskopio (JSON)',
        'btn.export_json': 'Vie Varmuuskopio (JSON)',
        ...
        'loan.return_by': 'Palautettava',
        'loan.overdue': 'Myöhässä!',
        'loan.unknown': 'Tuntematon',
        ...
        'manual.privacy.title': 'Tiedot & Varmuuskopiot',
        'manual.privacy.body': 'TIEDOT: Kirjasi tallennetaan tälle laitteelle ja synkronoidaan Google Driveen (Vihreä piste). \n\nVARMUUSKOPIOT:\n• JSON (Suositus): Tallentaa KAIKEN (myös Kuvat). Käytä tätä siirtääksesi kirjaston toiseen laitteeseen.\n• CSV: Tallentaa vain tekstin (Excel). Ei kuvia.',
        ...
        'manual.add.body': 'Napsauta "Lisää Kirja" -painiketta. Voit skannata viivakoodin, hakea tai syöttää tiedot käsin. Käytä "Vie Varmuuskopio (JSON)" tallentaaksesi kaiken (MUKAAN LUKIEN KUVAT) ja "Tuo Varmuuskopio" palauttaaksesi sen.',
    ...
    et: {
        ...
        'btn.import_json': 'Impordi Varukoopia (JSON)',
        'btn.export_json': 'Ekspordi Varukoopia (JSON)',
        ...
        'loan.return_by': 'Tagastada',
        'loan.overdue': 'Hilinenud!',
        'loan.unknown': 'Tundmatu',
        ...
        'manual.privacy.title': 'Andmed ja Varukoopiad',
        'manual.privacy.body': 'ANDMED: Raamatud on selles seadmes ja sünkroonitud Google Drive\'iga (Roheline täpp). \n\nVARUKOOPIAD:\n• JSON (Soovitatav): Salvestab KÕIK (ka Pildid). Kasuta seda teise seadmesse kolimiseks.\n• CSV: Salvestab ainult teksti (Excel). Pilte ei salvestata.',
        ...
        'manual.add.body': 'Klõpsa "Lisa Raamat" nuppu. Saad skaneerida triipkoodi, otsida või sisestada andmed käsitsi. Kasuta "Ekspordi Varukoopia (JSON)" funktsiooni kogu info (KAASA ARVATUD PILDID) salvestamiseks.',
