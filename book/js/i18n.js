export const translations = {
    en: {
        ...
        'manual.privacy.body': 'Your data belongs to you. We store your books in "Local Storage" on this browser. When you sign in, we save a backup file (mybookshelf.json) to a private invisible folder in your Google Drive (AppData). A green status dot indicates your data is successfully synced.',
        ...
        'manual.privacy.body': 'Tietosi ovat sinun. Tallennamme kirjasi selaimesi muistiin. Kirjautuessasi tallennamme varmuuskopion (mybookshelf.json) yksityiseen kansioon Google Drivessasi. Vihreä tilapiste kertoo, että tiedot on synkronoitu onnistuneesti.',
    ...
    et: {
        ...
        'manual.privacy.body': 'Sinu andmed kuuluvad sulle. Salvestame raamatud brauseri mällu. Sisselogimisel salvestame varukoopia (mybookshelf.json) privaatsesse kausta sinu Google Drive\'is. Roheline olekutäpp näitab, et andmed on edukalt sünkroonitud.',
